...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-dark">Peminjaman Sudah Dikembalikan</h1>
        <small>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berikut merupakan data peminjaman sudah dikembalikan</h6>
        </div>
        <div class="card-body">
            <?= $this->session->flashdata('message'); ?>
            <a class='btn btn-danger' href="statusPengembalian">
            ...
            <div class="table-responsive">
                ...
                <a href="<?php echo base_url("admin/peminjaman/statusPengembalian"); ?>"
