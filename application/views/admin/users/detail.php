...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Detail Peminjam</h1>
        <?php $no = 1;
        foreach ($users as $usr) : ?>
        <small>
            <div class="text-muted"> Manajemen Peminjam &nbsp;/&nbsp; Peminjam&nbsp; /&nbsp; <a
                    href="<?= base_url() . 'admin/users/detail/' . $usr->id_user ?>">Detail Peminjam</a></div>
        </small>
        <?php endforeach ?>
    </div>
    <div class="row">
    ...
    <div class="card mb-3" style="max-width: 700px;">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Detail Akun Peminjam</h6>
        </div>
        <div class="row no-gutters">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <h5 class="card-title text-dark">No. Telp &nbsp;: <?= $usr->no_telp ?></h5>
